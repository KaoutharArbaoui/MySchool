    ...
    <ul class="nav-links">
        ...
        <li>
            <a href="eleve.php">
                ...
                <span class="link_name">Elèves</span>
            </a>
            <ul class="sub-menu blank">
                <li><a class="link_name" href="eleve.php">Elèves</a></li>
            </ul>
        </li>
        <li>
        ...
        <li>
            <div class="icon-link">
                <a href="#">
                    ...
                    <span class="link_name">Salles/Equipements</span>
                </a>
                <i class='bx bxs-chevron-down arrow'></i>
            </div>
            <ul class="sub-menu">
                <li><a class="link_name" href="#">Salles/Equipements</a></li>
                <li><a href="#">a</a></li>
                <li><a href="#">b</a></li>
                <li><a href="#">c</a></li>
            </ul>
        ...
        <li>
            <a href="#">
                ...
                <span class="link_name">Séances</span>
            </a>
            <ul class="sub-menu blank">
                <li><a class="link_name" href="#">Séances</a></li>
            </ul>
        </li>
        <li>
            <a href="#">
        ...
        <li>
            <div class="profile-details">
                ...
                <div class="name-job">
                    <div class="profile_name"><a href="logout.php" style="color: aliceblue">Administrateur</a></div>
                    <div class="job">MySchool</div>
                </div>
...
<section class="home-section">
    <div class="home-content">
        ...
        <span class="text">MySchool App</span>
    </div>
</section>
