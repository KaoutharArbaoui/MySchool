...
if (!$con) {
    ...
    $sql ="SELECT  niveau,count(*) AS frq FROM eleves GROUP BY niveau";
    $result = mysqli_query($con,$sql);
    $chart_data="";
    while ($row = mysqli_fetch_array($result)) {

        $productname[]  = "Niveau --> ".$row['niveau'];
        $sales[] = $row['frq'];
    }
...
<div style="width:70%;hieght:20%;text-align:center">
    <h2 class="page-header" >La fréquence des élèves dans chaque niveau</h2></br></br>
