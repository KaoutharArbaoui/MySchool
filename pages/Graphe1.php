...
if (!$con) {
    ...
    $sql ="SELECT  sexe,count(*) AS frq FROM eleves GROUP BY sexe";
...
<div style="width:70%;hieght:20%;text-align:center">
    <h2 class="page-header" >La fréquence des filles et garçons</h2></br></br>
...
<script type="text/javascript">
    ...
    var myChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
            labels:<?php echo json_encode($sexee); ?>,
            datasets: [{
                label: '',
                fill: false,
                lineTension: 0.1,
