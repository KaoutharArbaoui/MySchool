...
if(isset($_POST['insert'])){
    ...
    $sql = "INSERT INTO `eleves`(`nom`, `prenom`, `adresse`, `sexe`, `datenaiss`, `lieunaiss`, `niveau`, `annee`, `doublant`,
                     `prix`, `pere`, `metier`, `mere`, `tele`, `mail`) 
                     VALUES (:nom,:prenom,:adresse,:sexe,:datenaiss,:lieunaiss,
                             :niveau,:annee,:doublant,:prix,:pere,:metier,:mere,:tele,:mail)";
    $res = $pdo->prepare($sql);
    $exec = $res->execute(array(":nom"=>$nom,":prenom"=>$prenom,":adresse"=>$adresse,":sexe"=>$sexe,":datenaiss"=>$datenaiss
    ,":lieunaiss"=>$lieunaiss,":niveau"=>$niveau,":annee"=>$annee,":doublant"=>$doublant,":prix"=>$prix,":pere"=>$pere,":metier"=>$metier
    ,":mere"=>$mere,":tele"=>$tele,":mail"=>$mail));
                ...
                <form action="create.php" method="post" >
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select  name="lieunaiss" class="form-control">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select  name="doublant" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input name="prix" class="form-control" required>
                        <span class="invalid-feedback"></span>
                    </div>
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <input name="pere" class="form-control" required>
                        <span class="invalid-feedback"></span>
                    </div>
                    <div class="form-group">
                        <label><b>Nom et prénom mère</b></label><span style="color:red">*</span>
                        <input name="mere" class="form-control" required>
                        <span class="invalid-feedback"></span>
                    </div>
                    <div class="form-group">
                        <label><b>Métier du père</b></label><span style="color:red">*</span>
                        <input name="metier" class="form-control" required>
                        <span class="invalid-feedback"></span>
                    </div>
                    <div class="form-group">
                        <label><b>Téléphone père ou mère</b></label><span style="color:red">*</span>
                        <input name="tele" class="form-control" required maxlength="10">
                        <span class="invalid-feedback"></span>
                    </div>
                    <div class="form-group">
